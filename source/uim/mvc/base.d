...
class DMVCObject : IMVCObject, IRegisterable {
  ...
  this() { initialize; }
  this(IData[string] configSettings = nullSettings) { this().initialize(configSettings); }
  this(IApplication newApplication, IData[string] configSettings = null) { this(configSettings).application(newApplication); }
  this(string newName, IData[string] configSettings = null) { this(configSettings).name(newName); }
  this(STRINGAA newParameters, IData[string] configSettings = null) { this(configSettings).parameters(newParameters); }
  this(IApplication newApplication, string newName, IData[string] configSettings = null) { this(newApplication).name(newName); }
  this(IApplication newApplication, STRINGAA newParameters, IData[string] configSettings = null) { this(newApplication,configSettings).parameters(newParameters); }
  this(string newName, STRINGAA newParameters, IData[string] configSettings = null) { this(newName, configSettings).parameters(newParameters); }
  this(IApplication newApplication, string newName, STRINGAA newParameters, IData[string] configSettings = null) { this(newApplication, newName, configSettings).parameters(newParameters); }
