...
this(DMVCView myView, DEntity myEntity) { this(myView).entity(myEntity); }
this(string myName, DEntity myEntity) { this(myName).entity(myEntity); }
this(DMVCView myView, string myName, DEntity myEntity) { this(myView, myName).entity(myEntity); }
` : ``)~
(withEntities ? `
this(DEntity[] myEntities) { this().entities(myEntities); }
this(DMVCView myView, DEntity[] myEntities) { this(myView).entities(myEntities); }
this(string myName, DEntity[] myEntities) { this(myName).entities(myEntities); }
this(DMVCView myView, string myName, DEntity[] myEntities) { this(myView, myName).entities(myEntities); }
` : ``);
}
...
auto `~name~`(DMVCView myView, DEntity myEntity) { return new D`~name~`(myView, myEntity); }
auto `~name~`(string myName, DEntity myEntity) { return new D`~name~`(myName, myEntity); }
auto `~name~`(DMVCView myView, string myName, DEntity myEntity) { return new D`~name~`(myView, myName, myEntity); }
` : ``)~
(withEntities ? `
auto `~name~`(DEntity[] myEntities) { return new D`~name~`(myEntities); }
auto `~name~`(DMVCView myView, DEntity[] myEntities) { return new D`~name~`(myView, myEntities); }
auto `~name~`(string myName, DEntity[] myEntities) { return new D`~name~`(myName, myEntities); }
auto `~name~`(DMVCView myView, string myName, DEntity[] myEntities) { return new D`~name~`(myView, myName, myEntities); }
` : ``);
}
