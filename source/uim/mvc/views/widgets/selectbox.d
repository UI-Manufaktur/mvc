...
**********************************************************************************************************/
module uim.mvc.views.widgets.selectbox;
...
class DMVCSelectBoxWidget : DWidget {
  ...
  string render(Json someData, IContext formContext) {
      ...
      if (myData.isSet("disabled"]) && is_array(myData["disabled"])) {
