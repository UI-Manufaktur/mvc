...
class DMVCWidgetLocator {
     ...
     * @throws \RuntimeException When class does not implement IMVCWidget.
     */
    void add(array $widgets) {
        ...
        foreach ($widgets as myKey: $widget) {
            ...
            if (is_object($widget) && !($widget instanceof IMVCWidget)) {
     ...
     * @return uim.mvc.views\Widget\IMVCWidget IMVCWidget instance.
     * @throws \RuntimeException when widget is undefined.
     */
    auto get(string myName): IMVCWidget
    {
        ...
        if (_widgets[myName] instanceof IMVCWidget) {
     ...
     * @return uim.mvc.views\Widget\IMVCWidget Widget instance.
     * @throws \ReflectionException
     */
    protected IMVCWidget _resolveWidget(myConfig) {
        ...
        if (count(myConfig)) {
           ...
           DMVCWidget\IMVCWidget $instance = $reflection.newInstanceArgs($arguments);
        } else {
            DMVCWidget\IMVCWidget $instance = new myClassName(_templates);
        }
