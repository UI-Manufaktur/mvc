...
class HtmlHelper : DHelper {
  ...
  /**
    ...
    */
  string link(string title, myUrl = null, DOptions someOptions = null) {
    $escapeTitle = true;
    if (myUrl  !is null) {
  ...
  /**
    ...
    * @link https://book.UIM.org/4/en/views/helpers/html.html#creating-links
    */
  string linkFromPath(string title, string myPath, array myParams = null, DOptions someOptions = null) {
  ...
  /**
    ...
    */
  Nullable!string css(myPath, DOptions someOptions = null) {
      myOptions += [
          "once": true,
          "block": null,
          "rel": "stylesheet",
  ...
  /**
    ...
    */
  Nullable!string script(myUrl, DOptions someOptions = null) {
      _defaults = [
          "block": null,
          "once": true,
  ...
  /**
    ...
    */
  Nullable!string scriptBlock(string script, DOptions someOptions = null) {
  ...
  /**
    ...
    * @link https://book.UIM.org/4/en/views/helpers/html.html#creating-inline-javascript-blocks
    */
  void scriptStart(DOptions someOptions = null) {
  ...
  /**
    ...
    */
  string image(myPath, DOptions someOptions = null) {
      if (is_string(myPath)) {
  ...
  /**
    ...
    */
  string tableRow(string myContents, DOptions someOptions = null) {
  ...
  /**
    ...
    * @param array<string, mixed> myOptions HTML attributes.
    */
  string tableCell(string myContents, DOptions someOptions = null) {
  ...
  /**
    ...
    */
  string tag(string myName, Nullable!string text = null, DOptions someOptions = null) {
  ...
  /**
    ...
    */
  string div(Nullable!string myClass = null, Nullable!string text = null, DOptions someOptions = null) {
      if (!empty(myClass)) {
  ...
  /**
    ...
    */
  string para(Nullable!string myClass, Nullable!string text, DOptions someOptions = null) {
  ...
  /**
    ...
    */
  string media(myPath, DOptions someOptions = null) {
      myOptions += [
          "tag": null,
          "pathPrefix": "files/",
          "text": "",
  ...
  /**
    ...
    */
  string nestedList(array $list, DOptions someOptions = null, array $itemOptions = null) {
      myOptions += ["tag": "ul"];
  ...
  /**
    ...
    */
  protected string _nestedListItem(array myItems, DOptions someOptions, array $itemOptions) {
      $out = "";
