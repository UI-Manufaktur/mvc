...
/* StringTemplate templater() {
  ...
  // Default widgets
  protected string[][string] _defaultWidgets = [
      "button": ["Button"],
      "checkbox": ["Checkbox"],
      "file": ["File"],
      "label": ["Label"],
  ...
  /**
    ...
    *
    * @param uim.mvc.views\Form\ContextFactory|null $instance The context factory instance to set.
  ...
  /* string fieldset(string myFields = "", DOptions someOptions = null) {
      ...
      if (myFieldset != false) {
          ...
          if (is_array(myFieldset) && !empty(myFieldset)) {
              myFieldsetParams["attrs"] = _templater().formatAttributes(myFieldset);
          }
...
/*   protected string _inputContainerTemplate(DOptions someOptions) {
  ...
  string button(string title, DOptions someOptions = null) {
      ...
      if ($confirmMessage) {
          ...
          myOptions["onclick"] = _templater().format("confirmJs", [
  ...
  string postLink(string title, myUrl = null, DOptions someOptions = null) {
      ...
      if ($confirmMessage) {
          ...
          $onClick = _templater().format("confirmJs", [
              "confirmMessage": h($confirmMessage),
              "formName": $formName,
              "confirm": $onClick,
          ]);
  ...
  protected array _initInputField(string myField, DOptions someOptions = null) {
      ...
      if (!isSet(myOptions, "val", "default")) {
  ...
  /**
    ...
    * @return uim.mvc.views\Form\IContext Context provider.
