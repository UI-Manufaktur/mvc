...
void testBKLControllerComponent(DMVCControllerComponent aControllerComponent, string controllercomponentName) { 
  ...
  assert(cast(DMVCControllerComponent)BKLControllerComponent, "ControllerComponent "~controllercomponentName~" couldn't cast to DMVCControllerComponent");
  assert(cast(IBKLControllerComponent)BKLControllerComponent, "ControllerComponent "~controllercomponentName~" couldn't cast to DMVCControllerComponent");
}